...
module.exports = function (req, res, next) {
    ...
    child = exec('java -Xmx512m -cp C:\\egg\\java\\pd4ml_demo.jar Pd4Cmd "'+url+'" 850 -out public\\invoices\\'+pdffilename+' -insets 5,5,5,5,pt -bgimage "http://localhost:8111/images/watermark.png"',
